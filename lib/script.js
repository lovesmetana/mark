...
function check1level() {
  ...
  if (count == 10 && population == 3) {
    stopLife();
    document.getElementById('info').innerHTML = 'ты имба';
  } else if (count > 10 && population != 3) {
    stopLife();
    document.getElementById('info').innerHTML = 'не получилось(((';
  }
}
...
function check4level() {
  ...
  if (count == 20 && population == 12) {
    stopLife();
    document.getElementById('info').innerHTML = 'ты имба';
  } else if (count > 20 && population != 12) {
    stopLife();
    document.getElementById('info').innerHTML = 'не получилось((((';
  }
}
